...
TARGET_MODULE_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "Celestial v1.03-Modules"))

# Timing sync paths
SOURCE_TIMING_DIR = os.path.abspath('./Timings')
TARGET_TIMING_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "Celestial v1.03-Timings"))
