...
---@module Menu.CelestialTab
local CelestialTab = require("Menu/CelestialTab")
...
function Menu.init()
	...
	ThemeManager:SetFolder("Celestial v1.03-Themes")

	-- Configure SaveManager.
	SaveManager:SetLibrary(Library)
	SaveManager:IgnoreThemeSettings()
	SaveManager:SetFolder("Celestial v1.03-Configs")
